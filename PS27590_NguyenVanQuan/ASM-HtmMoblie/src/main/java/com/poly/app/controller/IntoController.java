...
public class IntoController {
	...
	public ResponseEntity<String> sendMail(@RequestParam("codemail") Optional<String> email) {
		mailerServiceImpl.queue(email.orElse("abc@gmail.com"), "Mã Xác Nhận Từ QTMobile",
				"    <div style=\"width:80%; margin:0 auto;text-align: center ;\">\r\n"
						+ "            <h1 style=\"color:#080202 ;\">QTMobile</h1>\r\n"
						...
						+ "</h2>    \r\n" + "             <br>\r\n"
						+ "              <p style=\"font-size: 15px;font-weight: 200;\">Tin nhắn này được gửi tới bạn theo yêu cầu của QTMobile.\r\n"
						+ "                QTMobile © 2023 All rights re6served. Privacy Policy|T&C|System Status</p>\r\n"
						+ "    </div> ");
